...
SLUG_TO_HUB_FILE = os.path.join(BASE_DIR, "data", "slug_to_hub_c.json")
...
BADGES = {
    ...
    "general-scams": ["Scam category hub", "Premium internal linking", "Built for repeat use"],
}
...
<div class="page-shell">
  ...
  <main class="content-section">
    <div class="breadcrumbs">
      <a href="{SITE}/check">Scam Check Now</a> / <a href="{SITE}{HUB_PREFIX}/">C Hubs</a> / <span>{safe_html(title_text)}</span>
    </div>
    ...
    <div class="info-box">
      This hub groups similar pages together so people can scan patterns fast, compare suspicious messages, and come back quickly when the next risky message shows up.
    </div>
...
def main():
    ...
    print("C hubs built successfully.")
